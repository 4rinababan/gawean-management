...
namespace TaskManagement.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260915174236_AddBroadcasts")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskManagement.Domain.Automation.AutomationRule", b =>
                {
                    ...
                    b.HasIndex("ProjectId", "Enabled");

                    b.ToTable("automation_rules", (string)null);
                });

            modelBuilder.Entity("TaskManagement.Domain.Broadcasts.Broadcast", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TaskManagement.Domain.Broadcasts.BroadcastDismissal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("broadcast_dismissals", (string)null);
                });

            modelBuilder.Entity("TaskManagement.Domain.Broadcasts.BroadcastTargetUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("broadcast_target_users", (string)null);
                });

            modelBuilder.Entity("TaskManagement.Domain.Diagnostics.ErrorLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TaskManagement.Domain.Issues.IssueAiNote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("issue_ai_notes", (string)null);
                });

            modelBuilder.Entity("TaskManagement.Domain.Issues.IssueViewer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("issue_viewers", (string)null);
                });
            ...
            modelBuilder.Entity("TaskManagement.Domain.Organizations.OrganizationAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("organization_audit_logs", (string)null);
                });
            ...
            modelBuilder.Entity("TaskManagement.Domain.Wiki.WikiPage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("OrganizationId", "ParentPageId");
            ...
            modelBuilder.Entity("TaskManagement.Domain.Broadcasts.BroadcastDismissal", b =>
                {
                    b.HasOne("TaskManagement.Domain.Broadcasts.Broadcast", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TaskManagement.Domain.Wiki.WikiPage", b =>
                {
                    ...
                    b.HasOne("TaskManagement.Domain.Wiki.WikiPage", null)
                        .WithMany()
